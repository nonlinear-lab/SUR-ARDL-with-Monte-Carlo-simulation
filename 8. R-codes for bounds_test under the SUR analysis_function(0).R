...
sur_ardl_bounds <- function(x1,x2,x3,x4,x5,y1,y2,y3,y4,y5){
  ...
  bounds1 <- ((ssr_r1 - ssr_ur1) / df_num) / (ssr_ur1 / df_den)
  bounds2 <- ((ssr_r2 - ssr_ur2) / df_num) / (ssr_ur2 / df_den)
  bounds3 <- ((ssr_r3 - ssr_ur3) / df_num) / (ssr_ur3 / df_den)
  bounds4 <- ((ssr_r4 - ssr_ur4) / df_num) / (ssr_ur4 / df_den)
  bounds5 <- ((ssr_r5 - ssr_ur5) / df_num) / (ssr_ur5 / df_den)
